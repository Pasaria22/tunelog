...
# Frontend is not able to talk to backend if deployed via docker, possible cause is .env , maybe in fronted api.ts it is not able to access .env or docker is  not working becuase of /localhost or /backend, 
